...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { address: @warehouse.address, email: @warehouse.email, name: @warehouse.name, phone_num: @warehouse.phone_num, type: @warehouse.type } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { address: @warehouse.address, email: @warehouse.email, name: @warehouse.name, phone_num: @warehouse.phone_num, type: @warehouse.type } }
